describe('dashboard_again', () => {
  ...
  it('issue5 - main page has correct div with initially 0 elements', () => {
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
    .should('have.length', 0);
  })

  it('issue5 - main page correctly loads 5 dashboards', () => {
    cy.wait(1000);
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
  ...
  it('issue5 - main page 1st dashboard has correct title, description and CSS', () => {
    cy.wait(1000);
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
    .first()
    ...
    .find('div')
    .first()
    .should('have.css', 'margin', '22px')
    .should('have.css', 'padding', '5px')
    .should('have.css', 'background-color', 'rgba(233, 240, 240, 0.5)')
    .should('have.css', 'border-radius', '10px')
    .should('have.css', 'text-align', 'center')
    .should('have.css', 'box-shadow', 'rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px 0px')
  })

  it('issue5 - main page 2nd dashboard has correct title, description and CSS', () => {
    cy.wait(1000);
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
    .eq(1)
  ...
  it('issue5 - main page 3rd dashboard has correct title, description and CSS', () => {
    cy.wait(1000);
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
    .eq(2)
  ...
  it('issue5 - main page 4th dashboard has correct title, description and CSS', () => {
    cy.wait(1000);
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
    .eq(3)
  ...
  it('issue5 - main page 5th dashboard has correct title, description and CSS', () => {
    cy.wait(1000);
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
    .last()
  ...
  it('issue5 - clicking works OK in element 1', () => {
    cy.wait(1000);
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
    .first()
  ...
  it('issue5 - clicking works OK in last element with unpredictable id', () => {
    cy.wait(1000);
    cy.get('div[data-cy=dashboardsList]')
    .find('div')
    .last()
    ...
    cy.url()
    .should('be.equal', 'http://localhost:3000/dashboards/11')
  })
})
